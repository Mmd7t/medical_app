              ...
              return Container(
                ...
                child: ListView(
                  children: [
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(TreatmentCenter.routeName),
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(CalculateWaterPage.routeName),
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(DiagnosisKidneyPage.routeName),
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(ProtienFood.routeName),
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(PotassiumFood.routeName),
                    ...
                    ListTile(
                      onTap: () => Navigator.of(context)
                          .pushReplacementNamed(AllowedFood.routeName),
